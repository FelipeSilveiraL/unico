...
require_once('../config/query.php'); //SISTEMA bpm
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="index.php?pg=1" class="logo d-flex align-items-center">
                <span class="d-none d-lg-block">BPM<img src="../../../img/fd_logo.png" alt="" srcset=""></span>
            </a>
        ...
        <div class="search-bar">
            <form class="search-form d-flex align-items-center" method="POST" action="pesquisa.php?pg=1&tela=1">
                <input type="text" name="pesquisa" placeholder="localizar módulos" title="Enter search keyword">
