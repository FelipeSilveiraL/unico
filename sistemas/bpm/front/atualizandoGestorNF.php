              ...
              ?>
                  <form class="row g-3" action="http://<?= $_SESSION['servidorOracle'] ?>/<?= $_SESSION['smartshare'] ?>/bd/atualizandoGestorNF.php?pg=<?= $_GET['pg'] ?>" method="POST" >
                    ...
                    <div class="text-center">
                      <a href="http://<?= $_SERVER['SERVER_ADDR'] ?>/unico/sistemas/bpm/front/gestorNF.php?pg=<?=$_GET['pg']?>"> <button type="button" class="btn btn-danger">NÃO ATUALIZAR, me tire daqui!</button></a>
