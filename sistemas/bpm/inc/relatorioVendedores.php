...
$vendedores = "SELECT * FROM bpm_vendedores";

$sucesso = $conn->query($vendedores);


$arquivo = 'vendedores.xls';
        ...
        while (($row_relatorio = $sucesso->fetch_assoc()) != FAlSE) {
            ...
            $html .= "
                        <tr>";
            $html .=  empty($row_relatorio['ID_VENDEDOR']) ? '<td>----------</td>' : '<td>' . $row_relatorio['ID_VENDEDOR'] . '</td>';
