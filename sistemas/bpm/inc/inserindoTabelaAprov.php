...
$conexao = oci_parse($connBpmgp, $aprovadoresQuery);
oci_execute($conexao);
...
while ($rowaprov = oci_fetch_array($conexao, OCI_ASSOC)) {
  ...
  <a href="../inc/deletarApFilial.php?pg=' . $_GET['pg'] . '&id=' . $rowaprov['ID_APROVADOR'] . '" title="Desativar" ' . $usuarioFuncao . ' style="margin-top: 3px;color: white;" class="btn-danger btn-sm" ><i class="bi bi-trash"></i></a>
  </td> 
