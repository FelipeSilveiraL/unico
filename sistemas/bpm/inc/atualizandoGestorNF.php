...
while(($count = oci_fetch_array($resultadoCount, OCI_BOTH)) != false)  {
    ...
    if($count['APROVADOR_FILIAL'] == $idGestor){
        $update = "UPDATE aprovadores_nf SET aprovador_filial = '".$idGestorNovo ."' WHERE id_aprovador = ".$count['ID_APROVADOR']."";
    ...
    if($count['APROVADOR_AREA'] == $idGestor){
        $update_APROVADOR_AREA = "UPDATE aprovadores_nf SET aprovador_area = '".$idGestorNovo ."' WHERE id_aprovador = ".$count['ID_APROVADOR']."";
    ...
    if($count['APROVADOR_MARCA'] == $idGestor){
        $update_APROVADOR_MARCA = "UPDATE aprovadores_nf SET aprovador_marca = '".$idGestorNovo ."' WHERE id_aprovador = ".$count['ID_APROVADOR']."";
    ...
    if($count['APROVADOR_SUPERINTENDENTE'] == $idGestor){
        $update_APROVADOR_SUPERINTENDENTE = "UPDATE aprovadores_nf SET aprovador_superintendente = '".$idGestorNovo ."' WHERE id_aprovador = ".$count['ID_APROVADOR']."";
    ...
    if($count['APROVADOR_GERENTE'] == $idGestor){
        $update_APROVADOR_GERENTE = "UPDATE aprovadores_nf SET aprovador_gerente = '".$idGestorNovo ."' WHERE id_aprovador = ".$count['ID_APROVADOR']."";
    ...
    if($count['APROVADOR_GESTOR'] == $idGestor){
        $update_APROVADOR_GESTOR = "UPDATE aprovadores_nf SET aprovador_gestor = '".$idGestorNovo ."' WHERE id_aprovador = ".$count['ID_APROVADOR']."";
...
header('location: ../front/gestorNF.php?pg='.$_GET['pg'].'&msn=6');
