...
if ($_SESSION['id_usuario'] == NULL) {
    header('Location: ../front/login.php?pg=' . $_GET['pg'] . '&msn=9'); //sessão não iniciada!
}
?>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="index.php?pg=1" class="logo d-flex align-items-center">
                <span class="d-none d-lg-block">Blog<img src="../../../img/fd_logo.png" alt="" srcset=""></span>
            </a>
            ...
            <ul class="d-flex align-items-center">
                ...
                <li class="nav-item dropdown pe-3">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                        ...
                        <li>
                            <a class="dropdown-item d-flex align-items-center" href="ajuda.php?pg=5">
